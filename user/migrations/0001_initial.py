    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_code', models.PositiveIntegerField(validators=[django.core.validators.MaxValueValidator(999)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('order_status', 'Order status'), ('post_update', 'Post update'), ('earnings', 'Earnings'), ('new_subscription', 'New subscrition'), ('product_update', 'Product update'), ('stock_related', 'stock related')])),
                ('uri', models.URLField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='wishlist_for', to=settings.AUTH_USER_MODEL)),
