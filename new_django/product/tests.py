...
class TestProduct(TestCase):
    ...
    def setUp(self):
        ...
        self.category_3 = Category.objects.create(name='kitchen_appliances')
        self.category_4 = Category.objects.create(name='cookware')
        self.category_5 = Category.objects.create(name='furniture')

        self.subcategory_3 = SubCategory.objects.create(name='small_appliances', category=self.category_3)
        self.subcategory_4 = SubCategory.objects.create(name='large_appliances', category=self.category_3)
        self.subcategory_5 = SubCategory.objects.create(name='pots_and_pans', category=self.category_4)
        self.subcategory_6 = SubCategory.objects.create(name='living_area', category=self.category_5)
        self.subcategory_7 = SubCategory.objects.create(name='dining_area', category=self.category_5)
        ...
        test_product_3_data = {
            ...
            'sub_category': self.subcategory_3,
        ...
        test_product_4_data = {
            ...
            'sub_category': self.subcategory_4,
            'tags': json.dumps(test_product_4_features)
            'tag_values': [test_product_4_features.values + ['phillips refrigirator']]
        }
        ...
        test_product_5_data = {
            ...
            'sub_category': self.subcategory_5,
            'tags': json.dumps(test_product_5_features)
            'tag_values': [test_product_5_features.values + ['all-clad']]
        }
        ...
        test_product_7_data = {
            ...
            'price': 700,
            'quantity': 10,
            'sub_category': self.subcategory_7,
            'supplier': self.test_user_6,
            'tags': json.dumps(test_product_7_features)
            'tag_values': [test_product_7_features.values + ['all-clad']]
        }
        ...
        test_product_6_data = {
            ...
            'quantity': 8,
            'supplier': self.test_user_6,
            'sub_category': self.subcategory_6,
            'tags': json.dumps(test_product_6_features)
            'tag_values': [list(test_product_6_features.values()) + ['all-clad']]
        }
        ...
        self.test_product_3 = Product.objects.create(**test_product_3)
        self.test_product_4 = Product.objects.create(**test_product_4)
        self.test_product_5 = Product.objects.create(**test_product_5)
        self.test_product_6 = Product.objects.create(**test_product_6)
        self.test_product_7 = Product.objects.create(**test_product_7)
    ...
    def test_product_name_vulgarity(self):
        test_product_7_data = {
            'name': 'fuckphoneX',
            'description': 'RAM 8GB, 32GB storage, 13Mp camera',
            'price': 700,
            'quantity': 10,
            'sub_category': self.sub_category_1,
            'supplier': self.test_user_1,
            'tags': json.dumps(test_product_1_features)
            'tag_values': [test_product_1_features.values + ['fuckphoneX']]
        }

        with self.assertRaises(ValidationError):
            test_praduct_name_vulgarity = Product.object.create(**test_product_7_data)
